...
\captionsetup{labelformat=empty}
    ...
    \centering
    \includegraphics[width=\linewidth]{evals_summary_figure_nokey.pdf}
\end{figure}
...
\begin{quote}\itshape ``Everyone in section was asked at least one question or another pertaining to the slides, which greatly helped with feeling engaged! If we got an answer wrong, Gagandeep was very encouraging and patient til we were able to find the correct solution.'' \normalfont --- Introductory Macroeconomics, Fall 2023\end{quote}
\begin{quote}\itshape ``Gagandeep is one of the best TAs I have had in my life, and I am very appreciative of the help he gave to all of us.'' \normalfont --- Applied Econometrics I, Fall 2024\end{quote}
\begin{quote}\itshape ``Gagandeep was one of the best teachers I have ever had. He is very passionate about what he does and cares about each and every student. He put in so much effort to create practice problems structured like our midterm questions.'' \normalfont --- Introductory Microeconomics, Winter 2026\end{quote}
