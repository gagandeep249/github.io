...
\end{tabular}}
\par\vspace{4pt}
{\footnotesize\raggedright $^{\dagger}$ Evaluated on an agree/disagree scale rather than the frequency scale. Evaluations not available: Winter 2020 was administered on an earlier platform and could not be recovered; Spring 2025 is not available on the current platform.\par}
\end{table}
