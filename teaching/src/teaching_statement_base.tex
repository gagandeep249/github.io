...
I make asking for help routine from the first week of a course. Questions are expected and encouraged, class time includes regular low-stakes opportunities to ask them, and office hours are informal. In the courses I have designed, the same expectation is written into policy: every student receives dropped attendances and no-questions-asked extensions automatically, so a difficult week never requires asking for an exception. A weighted 96 percent of respondents across all courses say I made them feel as though they could succeed in the class.
